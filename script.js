document.addEventListener('DOMContentLoaded', () => {
  ...
  // ==========================================================================
  // 9. Admin Message Inbox Modal Logic (Local Storage Database)
  // ==========================================================================
  ...
  const renderMessages = () => {
    ...
    if (messages.length === 0) {
      messagesList.innerHTML = `
        <div class="empty-state">
          ...
          <p>No messages received yet. Try sending one from the contact form!</p>
        </div>
      `;
      ...
      <div class="message-item" data-id="${msg.id}">
        <div class="message-item-header">
          <div class="sender-info">
            ...
            <p><a href="mailto:${escapeHTML(msg.email)}">${escapeHTML(msg.email)}</a></p>
          </div>
          <div class="message-meta">
            <span class="message-date">${msg.date}</span>
            <button class="message-delete-btn" aria-label="Delete message">
    ...
    // Attach individual delete click listeners
    const deleteButtons = messagesList.querySelectorAll('.message-delete-btn');
    deleteButtons.forEach(btn => {
      btn.addEventListener('click', (e) => {
        ...
        renderMessages();
        createToast('Message Deleted', 'Successfully removed message from inbox.', 'info');
      });
    });
  };
  ...
  if (clearBtn) {
    clearBtn.addEventListener('click', () => {
      if (confirm('Are you sure you want to clear all messages? This cannot be undone.')) {
        saveMessages([]);
        renderMessages();
        createToast('Inbox Cleared', 'All messages have been deleted.', 'success');
      }
    });
  }
